...
double guass_laguerre(double r_1, double r_2, double theta_1, double theta_2, double phi_1, double phi_2, int steps) {
    ...
    r_legendre(steps, theta);
    weights_legendre(steps, w_theta, theta, 0, pi);
    r_legendre(steps, phi);
    weights_legendre(steps, w_phi, phi, 0, 2*pi);
    gauss_laguerre(r, w_r, steps, 2);

    //double theta_1, theta_2,
    double delta_theta_1, delta_theta_2;
    //double phi_1, phi_2,
    double delta_phi_1, delta_phi_2;
    //double r_1, r_2,
    double delta_r_1, delta_r_2;
